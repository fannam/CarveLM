...
def parse_args():
    parser = argparse.ArgumentParser(description="Supervised fine-tuning recovery with Accelerate.")
    ...
    parser.add_argument("--wandb-run-name", default="supervised_finetune")
