...
The pruner and strategy implementations are shared with the LLM stack via
``carve_lm._pruning.width``; this module registers them into the VLM language
registries and binds the VLM adapter resolver, strategy registry, and
embedding-scoring helper.
"""
